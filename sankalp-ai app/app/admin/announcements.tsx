...
function PostModal({ visible, onClose, onPost }: {
  ...
  const handlePost = async () => {
    ...
    setIsPosting(true);
    try {
      await onPost({ title: title.trim(), body: body.trim(), type, department: department.trim() || "Government of NCT of Delhi", priority });
      resetForm();
      onClose();
    } catch (e: any) {
      ...
      <Pressable style={styles.overlay} onPress={onClose}>
        <Pressable style={styles.postCard} onPress={e => e.stopPropagation?.()}>
          ...
          <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
            ...
            <TextInput
              style={styles.input}
              placeholder="Government of NCT of Delhi"
              placeholderTextColor={Colors.textMuted}
              value={department}
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.empty}>
            ...
            <Text style={styles.emptySub}>Tap "Post" to publish a new announcement for Delhi citizens</Text>
