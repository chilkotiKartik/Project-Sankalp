    ...
    <View style={{ flex: 1, backgroundColor: "#F0FFF4" }}>
      ...
      >
        ...
        <View style={s.heroContent}>
          ...
          <View>
            <Text style={s.heroTitle}>Join Delhi's{"\n"}Civic Community</Text>
            <Text style={s.heroSub}>Sign up to report issues & earn civic points</Text>
          </View>
        </View>
      </LinearGradient>
          ...
          <Animated.View style={[s.card, { opacity: fadeAnim, transform: [{ translateY: slideAnim }, { translateX: shakeAnim }] }]}>
            {success ? (
              <View style={s.successBox}>
                ...
                <Text style={s.successSub}>Welcome to SANKALP AI. Your citizen account is active and you're ready to make Delhi better!</Text>
                <View style={s.successBadges}>
                  {["New Citizen", "Delhi Hero", "Problem Solver"].map(b => (
              ...
              <>
                ...
                <Text style={s.cardSub}>Join thousands of active Delhi citizens</Text>

                {/* Stats */}
                <View style={s.statsRow}>
                  {[
                    { num: "12K+", label: "Citizens" },
...
const s = StyleSheet.create({
  ...
  heroTitle: { color: "#fff", fontSize: 22, fontFamily: "Inter_700Bold", lineHeight: 30 },
  heroSub: { color: "rgba(255,255,255,0.85)", fontSize: 12, fontFamily: "Inter_400Regular", marginTop: 4 },
  ...
  statBox: {
    flex: 1, backgroundColor: "#F0FFF4", borderRadius: 12,
