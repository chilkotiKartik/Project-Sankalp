...
const SLIDES = [
  {
    ...
    avatar: { name: "Rahul Kumar", role: "Ward Officer, Delhi", photo: "https://randomuser.me/api/portraits/men/32.jpg" },
    badge: "🏛️",
    pill: "CIVIC TECH",
    title: "Report Issues,\nTransform Delhi",
    sub: "File complaints for potholes, garbage, broken streetlights and more — in under 30 seconds. Track real-time resolution.",
  ...
  },
  {
    ...
    avatar: { name: "Priya Sharma", role: "Tech Officer, GNCTD", photo: "https://randomuser.me/api/portraits/women/62.jpg" },
    badge: "🤖",
    pill: "AI POWERED",
    title: "Your Personal\nAI Civic Assistant",
  ...
  },
  {
    ...
    avatar: { name: "Sunita Verma", role: "Citizen, Delhi NCR", photo: "https://randomuser.me/api/portraits/women/44.jpg" },
    badge: "🛡️",
    pill: "ALWAYS SAFE",
    title: "Women Safety\n& Emergency SOS",
    sub: "One-tap SOS sends your location to police and family. Access Delhi's emergency services — police 100, women helpline 1090.",
      ...
      <View style={[ob.topBar, { top: Platform.OS === "web" ? 80 : insets.top + 20 }]}>
        <View style={ob.brand}>
          ...
          <View>
            ...
            <Text style={ob.brandGov}>Government of NCT Delhi</Text>
          </View>
        </View>
