...
const SLIDES = [
  {
    ...
    desc: "File complaints for potholes, garbage, broken streetlights and more — in under 30 seconds. Track real-time resolution.",
    bullets: [
      { icon: "analytics" as const,        text: "AI-powered complaint routing" },
      { icon: "time" as const,             text: "Real-time status tracking" },
      { icon: "bar-chart" as const,        text: "Ward health scoreboard" },
    ],
    stat1: "12K+",  stat1Label: "Citizens",
  ...
  },
  {
    ...
    stat1: "25",    stat1Label: "Police Stns",
  ...
  },
  {
    ...
    tag: "AI POWERED",
    tagColor: "#059669",
    heading: "Delhi's Smartest\nCivic Platform",
    desc: "AI scores every complaint for priority, routes to the right department, and shows real-time Delhi AQI and ward health.",
    bullets: [
      { icon: "flash" as const,            text: "AI priority scoring on every report" },
      { icon: "cloudy" as const,           text: "Live AQI monitoring — Delhi" },
      { icon: "people" as const,           text: "2,000+ active Delhi citizens" },
    ],
        ...
        <View style={[ob.topBar, { paddingTop: topPad + 10 }]}>
          <View style={ob.logoRow}>
            ...
            <View>
              ...
              <Text style={ob.logoGov}>Govt of NCT of Delhi</Text>
            </View>
          </View>
      ...
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={{ flex: 1 }}>
        ...
        >
          ...
          >
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={las.brandGov}>Government of NCT of Delhi</Text>
              </View>
            ...
            <View style={las.taglinePill}>
              ...
              <Text style={las.taglineText}>Delhi's citizens powering civic change</Text>
            </View>
          </LinearGradient>
          ...
          <View style={las.footer}>
            ...
            <Text style={las.footerSub}>SANKALP AI · NCT Delhi · 2025</Text>
          </View>
        </ScrollView>
