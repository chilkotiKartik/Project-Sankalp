...
const BILLS: Bill[] = [
  {
    id: "b1", type: "mcd", title: "MCD Property Tax", subtitle: "Municipal Corporation of Delhi",
    accountNo: "MCD-DL-07-2024-483920", amount: 4850, dueDate: "2026-03-31", status: "unpaid",
    period: "Annual 2024-25", icon: "business-outline", color: "#F59E0B",
    gradient: ["#78350F", "#92400E", "#B45309"],
  },
  {
    id: "b2", type: "djb", title: "DJB Water Bill", subtitle: "Delhi Jal Board",
    accountNo: "DJB-2024-W-991234", amount: 1240, dueDate: "2026-03-20", status: "overdue",
    period: "Feb 2026", icon: "water-outline", color: "#3B82F6",
    gradient: ["#1E3A5F", "#1D4ED8", "#2563EB"],
  },
  {
    id: "b3", type: "bses", title: "BSES Electricity", subtitle: "BSES Rajdhani Power Ltd",
    accountNo: "BSES-YMB-10287654", amount: 2180, dueDate: "2026-04-05", status: "unpaid",
    period: "Mar 2026", icon: "flash-outline", color: "#EF4444",
    gradient: ["#450A0A", "#7F1D1D", "#B91C1C"],
  },
  {
    id: "b4", type: "vehicle", title: "Vehicle Tax", subtitle: "Transport Dept. Delhi",
    accountNo: "DL-1C-AB-1234 · Maruti Swift", amount: 3500, dueDate: "2026-06-15", status: "unpaid",
    period: "Annual 2026-27", icon: "car-outline", color: "#22C55E",
    gradient: ["#052E16", "#14532D", "#166534"],
  },
  {
    id: "b5", type: "mcd", title: "MCD House Tax", subtitle: "Municipal Corporation of Delhi",
    accountNo: "MCD-HT-23-7741820", amount: 1800, dueDate: "2025-12-31", status: "paid",
    ...
    <View style={[styles.container, { paddingTop: Platform.OS === "web" ? 67 : insets.top }]}>
      ...
      <Animated.View style={[styles.header, { opacity: headerOpacity, transform: [{ translateY: headerSlide }] }]}>
        ...
        <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
          <View>
            <Text style={styles.headerTitle}>Delhi Gov Bills</Text>
            <Text style={styles.headerSub}>MCD · DJB · BSES · दिल्ली परिवहन</Text>
          </View>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: Platform.OS === "web" ? 34 : insets.bottom + 90 }}>
        ...
        <View style={styles.infoBox}>
          ...
          <Text style={styles.infoText}>Bill data is linked to your registered address. For disputes, visit your nearest citizen service center or call 1533 (MCD Helpline).</Text>
        </View>
      </ScrollView>
          ...
          <View style={styles.modalCard}>
            ...
            {payStep === "processing" && (
              <View style={styles.processingView}>
                ...
                <Text style={styles.processingSub}>Connecting to Delhi e-Pay Gateway...</Text>
              </View>
            )}
