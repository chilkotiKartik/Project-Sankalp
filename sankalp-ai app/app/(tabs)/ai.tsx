...
const QUICK_PROMPTS = [
  ...
  { label: "Govt Schemes 📋", text: "What government schemes am I eligible for in Delhi?" },
  ...
  { label: "Air quality 🌫️", text: "What is the current AQI in Delhi?" },
];
  ...
  const [messages, setMessages] = useState<Msg[]>([
    {
      id: "welcome",
      role: "ai",
      text: `Namaste ${user?.name?.split(" ")[0] || "Citizen"}! 🙏\n\nI am SANKALP AI, your Delhi civic assistant. I can help you:\n\n• File and track civic complaints\n• Access government schemes & helplines\n• Find hospitals, metro stations & services\n• Get real-time ward and pollution data\n\nHow can I assist you today?`,
      ts: new Date(),
    },
  ]);
    ...
    <View style={t.container}>
        ...
        <View style={t.headerContent}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <View style={t.onlineRow}>
              ...
              <Text style={t.onlineText}>Online · Delhi Civic Intelligence</Text>
            </View>
          </View>
      ...
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={{ flex: 1 }}>
        ...
        <View style={[t.inputBar, { paddingBottom: Platform.OS === "web" ? 20 : insets.bottom + 8 }]}>
          <TextInput
            style={t.input}
            placeholder="Ask me anything about Delhi..."
