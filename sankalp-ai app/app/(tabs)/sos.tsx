  ...
  const handleSOS = async () => {
    ...
    try {
      ...
      const alert = await triggerSOS({
        ...
        geo: g,
        ward: nearestPS[0]?.ward || "Central Delhi",
        wardNumber: 1,
        status: "active",
      });
          ...
          <View style={s.sheet}>
            ...
            <LinearGradient colors={["#3D0000", "#7F1D1D"]} style={s.sheetHead}
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={s.sheetSub}>Delhi Police & Command Center notified instantly</Text>
              </View>
            </LinearGradient>
          ...
          <View style={s.headerRow}>
            <View style={{ flex: 1 }}>
              <View style={s.gnctPill}>
                <Text style={s.gnctText}>🏛️ GNCTD · SANKALP AI · Emergency Command Center</Text>
              </View>
              <Text style={s.headerTitle}>SOS Emergency</Text>
              <Text style={s.headerSub}>Delhi Rapid Response System · 24/7 Active</Text>
            </View>
            {activeCount > 0 && (
        ...
        {sosAlerts.filter(s => s.status !== "resolved").length > 0 && (
          <View style={s.card}>
            <View style={s.cardHead}>
              ...
              <Text style={s.cardTitle}>Active Alerts in Delhi</Text>
            </View>
